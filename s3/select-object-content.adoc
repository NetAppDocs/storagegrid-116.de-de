...
Weitere Informationen finden Sie im https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["AWS Dokumentation für SelectObjectContent"^].
...
== Beispiel für die Anforderungssyntax
...
----
Die ersten Zeilen der abzufragenden Datei, `SUB-EST2020_ALL.csv`, So aussehen:
