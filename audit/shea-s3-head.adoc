...
Inhaltsgröße
 a| 
Die Größe des überprüften Objekts in Byte. Dieses Feld ist nicht in Operationen in Buckets enthalten.
...
Version-ID
 a| 
Die Version-ID der spezifischen Version eines Objekts, das angefordert wurde. Dieses Feld wird nicht von Vorgängen in Buckets und Objekten in nicht versionierten Buckets erfasst.
