...
. Befolgen Sie die Anweisungen auf der Seite Firmware aktualisieren auf der xref:accessing-storagegrid-appliance-installer-sg6000.adoc[StorageGRID-Appliance-Installationsprogramm] So führen Sie folgende Schritte aus:
+
