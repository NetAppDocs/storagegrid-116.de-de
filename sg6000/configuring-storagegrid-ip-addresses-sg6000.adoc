...
Wenn Sie die Verbindungskonfiguration ändern möchten, lesen Sie den xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Anweisungen zum Ändern der Link-Konfiguration des SG6000-CN Controllers].
