...
+
Weitere Informationen zu den Optionen finden Sie unter xref:configuring-network-links-sg100-and-sg1000.adoc[Netzwerkverbindungen konfigurieren].
...
+
Wenn Sie Änderungen an den VLAN-Einstellungen vorgenommen haben, hat sich das Subnetz für die Appliance möglicherweise geändert. Informationen zum Ändern der IP-Adressen für die Appliance finden Sie unter xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[Konfigurieren Sie StorageGRID-IP-Adressen].
