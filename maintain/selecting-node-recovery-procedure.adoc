...
xref:recovering-from-storage-node-failures.adoc[Wiederherstellung nach Ausfällen der Storage-Nodes]
...
xref:recovering-from-admin-node-failures.adoc[Wiederherstellung bei Ausfällen des Admin-Nodes]
...
Gateway-Node
 a| 
xref:recovering-from-gateway-node-failures.adoc[Wiederherstellung nach Gateway-Node-Ausfällen].
...
Archiv-Node
 a| 
xref:recovering-from-archive-node-failures.adoc[Wiederherstellung nach Ausfällen des Archivierungs-Nodes].
