...
Es gibt viele Möglichkeiten, eine konsistente Netzwerkschnittstelle über mehrere Hosts hinweg zu benennen; siehe xref:configuring-host-network.adoc[Konfigurieren des Hostnetzwerks] Für einige Beispiele.
