...
xref:creating-node-configuration-files.adoc[Erstellen von Knoten-Konfigurationsdateien]
...
.Verwandte Informationen
xref:example-etc-sysconfig-network-scripts.adoc[Beispiel /etc/sysconfig/Network-scripts]
